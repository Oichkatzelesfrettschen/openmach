...
/**
 * @brief Convert a mach_type_t to a human readable string.
 *
 * @param type The mach object type.
 * @return Constant string describing @p type.
 */
char *mach_type_string(mach_type_t type) {
  switch (type) {
  case MACH_TYPE_NONE:
    return "none";
  case MACH_TYPE_TASK:
