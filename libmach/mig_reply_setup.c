...
/**
 * @brief Prepare a MIG reply message header.
 *
 * The reply inherits ports from @p request and follows the standard reply ID
 * convention.
 */
void mig_reply_setup(const mach_msg_header_t *request,
