...
/**
 * @brief Deallocate the cached reply port after a timeout.
 *
 * This is typically called by MIG stubs if a timeout occurs.
 */
...
/**
 * @brief Release a reply port after use.
 *
 * This default implementation does nothing but is provided for API symmetry.
 */
/*ARGSUSED*/
