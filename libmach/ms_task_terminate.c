...
/**
 * @brief Terminate the given task.
 *
 * Attempts to terminate @p target_task using the syscall interface and falls
 * back to the MIG wrapper if interrupted.
 *
 * @param target_task Task to terminate.
