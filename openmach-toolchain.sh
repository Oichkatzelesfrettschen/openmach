#!/bin/bash
# OpenMach Archaeological Toolchain Configuration
...
openmach_cc() {
    case "$1" in
        ...
        "modernize")
            ...
            ;;
        *)
            echo "Usage: openmach_cc legacy|analyze|modernize"
            return 1
            ;;
    esac
    echo "CC is now: $CC"
...
echo "Use 'source ./openmach-toolchain.sh' then 'openmach_cc legacy|analyze|modernize'" # Changed path for sourcing
