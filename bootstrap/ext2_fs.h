...
#define EXT2_INODES_PER_BLOCK(s)                                               \
  (EXT2_BLOCK_SIZE(s) / sizeof(struct ext2_inode))
...
/* balloc.c */
extern int ext2_new_block(struct super_block *, unsigned long, unsigned long *,
                          unsigned long *);
...
extern unsigned long ext2_dcache_lookup(unsigned short, unsigned long,
                                        const char *, int);
extern void ext2_dcache_add(unsigned short, unsigned long, const char *, int,
                            unsigned long);
...
extern int ext2_rename(struct inode *, const char *, int, struct inode *,
                       const char *, int);
