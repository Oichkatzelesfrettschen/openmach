...
)
{
	...
	static const mach_msg_type_t inherit_memoryType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t child_taskCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t vector_startCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t vector_startType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_long_t emulation_vectorType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
...
)
{
	...
	static const mach_msg_type_t task_info_outCntType = {
		/* msgt_name = */		MACH_MSG_TYPE_INTEGER_32,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t old_stateCntType = {
		/* msgt_name = */		MACH_MSG_TYPE_INTEGER_32,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t thread_info_outCntType = {
		/* msgt_name = */		MACH_MSG_TYPE_INTEGER_32,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	InP->anywhere = anywhereanywhereType;
...
)
{
	...
	static const mach_msg_type_t set_maximumType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t new_protectionType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->set_maximum = set_maximumset_maximumType;

	InP->new_protectionType = *;

	InP->new_protection = new_protectionnew_protectionType;
...
)
{
	...
	static const mach_msg_type_t new_inheritanceType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->new_inheritanceType = *;

	InP->new_inheritance = new_inheritancenew_inheritanceType;
...
)
{
	...
	static const mach_msg_type_t source_addressType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t dest_addressType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->source_addressType = *;

	InP->source_address = source_addresssource_addressType;

	InP->sizeType = *;

	InP->size = sizesizeType;

	InP->dest_addressType = *;

	InP->dest_address = dest_addressdest_addressType;
...
)
{
	...
	static const mach_msg_type_t protectionCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t is_sharedCheck = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t object_nameCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t vm_statsCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		13,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_long_t init_port_setType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
...
)
{
	...
	static const mach_msg_type_t lock_valueType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->lock_value = lock_valuelock_valueType;
...
)
{
	...
	static const mach_msg_type_t object_readyCheck = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t may_cacheCheck = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t copy_strategyCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t default_managerType = {
		/* msgt_name = */		20,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t default_managerCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->default_managerType = *;

	InP->default_manager = default_managerdefault_managerType;
...
)
{
	...
	static const mach_msg_type_t should_cleanType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t should_flushType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t reply_toType = {
		/* msgt_name = */		21,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->should_cleanType = *;

	InP->should_clean = should_cleanshould_cleanType;

	InP->should_flushType = *;

	InP->should_flush = should_flushshould_flushType;
	...
	InP->reply_to = reply_toreply_toType;
...
)
{
	...
	static const mach_msg_type_t should_returnType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->should_returnType = *;

	InP->should_return = should_returnshould_returnType;
...
)
{
	...
	InP->vector_startType = *;

	InP->vector_start = vector_startvector_startType;

	InP->emulation_vectorType = *;
...
)
{
	...
	static const mach_msg_type_t slotType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t cpuType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t runningType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->running = runningrunningType;
...
)
{
	...
	static const mach_msg_type_t which_portType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t special_portCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->which_port = which_portwhich_portType;
...
)
{
	...
	static const mach_msg_type_t special_portType = {
		/* msgt_name = */		19,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->special_portType = ;

	InP->special_port = special_portspecial_portType;
...
)
{
	...
	static const mach_msg_type_t child_threadCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_long_t new_stateType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
...
)
{
	...
	static const mach_msg_type_t routine_entry_ptType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t routine_numberType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->routine_entry_ptType = *;

	InP->routine_entry_pt = routine_entry_ptroutine_entry_ptType;

	InP->routine_numberType = *;

	InP->routine_number = routine_numberroutine_numberType;
...
)
{
	...
	static const mach_msg_type_t basepcType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t boundspcType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->basepc = basepcbasepcType;

	InP->boundspcType = *;

	InP->boundspc = boundspcboundspcType;
...
)
{
	...
	InP->mask = maskmaskType;

	InP->anywhereType = *;

	InP->anywhere = anywhereanywhereType;

	InP->memory_objectType = *;
	...
	InP->copy = copycopyType;

	InP->cur_protectionType = *;

	InP->cur_protection = cur_protectioncur_protectionType;

	InP->max_protectionType = *;

	InP->max_protection = max_protectionmax_protectionType;

	InP->inheritanceType = *;

	InP->inheritance = inheritanceinheritanceType;
...
)
{
	...
	static const mach_msg_type_t error_valueType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->error_value = error_valueerror_valueType;
...
)
{
	...
	static const mach_msg_type_t object_readyType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->object_readyType = *;

	InP->object_ready = object_readyobject_readyType;

	InP->may_cacheType = *;

	InP->may_cache = may_cachemay_cacheType;

	InP->copy_strategyType = *;
...
)
{
	...
	static const mach_msg_type_t reasonType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t preciousType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->precious = preciouspreciousType;
...
)
{
	...
	static const mach_msg_type_t attributeType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t valueType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t valueCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->attribute = attributeattributeType;

	InP->valueType = *;

	InP->value = valuevalueType;
