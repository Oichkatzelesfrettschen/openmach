...
)
{
	...
	static const mach_msg_type_t deviceCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->modeType = Px\xd3<V;

	InP->mode = modemodeType;

	InP->nameType = Px\xd3<V;
...
)
{
	...
	InP->recnumType = Px\xd3<V;

	InP->recnum = recnumrecnumType;

	InP->dataType = Px\xd3<V;
...
)
{
	...
	static const mach_msg_type_long_t statusType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
	...
	InP->statusType.msgtl_number = statusCnt\xe9a\xfa\xff\xffL\x8bC(H\x83\xec\xffs M\x89\xe9H\x8dq8;
...
)
{
	...
	static const mach_msg_type_t receive_portType = {
		/* msgt_name = */		-1,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_long_t filterType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
	...
	InP->receive_portType = *;

	InP->receive_port = receive_portreceive_portType;

	if (MACH_MSG_TYPE_PORT_ANY(receive_portPoly))
		msgh_simple = FALSE;

	InP->receive_portType.msgt_name = receive_portPoly\xe9|\xfe\xff\xffH\x8bChH\x8b\x80\x88;
	...
	InP->filterType.msgtl_number = filterCnt\xe9a\xfa\xff\xffL\x8bC(H\x83\xec\xffs M\x89\xe9H\x8dq8;
...
)
{
	...
	static const mach_msg_type_t protType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t unmapType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	static const mach_msg_type_t pagerCheck = {
		/* msgt_name = */		17,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t statusType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1024,
		/* msgt_inline = */		TRUE,
	...
	InP->statusType.msgt_number = statusCnt\xe9a\xfa\xff\xffL\x8bC(H\x83\xec\xffs M\x89\xe9H\x8dq8;
...
)
{
	...
	static const mach_msg_type_t statusCntType = {
		/* msgt_name = */		MACH_MSG_TYPE_INTEGER_32,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
)
{
	...
	static const mach_msg_type_t filterType = {
		/* msgt_name = */		1,
		/* msgt_size = */		16,
		/* msgt_number = */		128,
		/* msgt_inline = */		TRUE,
	...
	InP->filterType.msgt_number = filterCnt\xe9a\xfa\xff\xffL\x8bC(H\x83\xec\xffs M\x89\xe9H\x8dq8;
