...
struct bus_driver atm_driver = {
    ...
    "atm",     atm_info, "",         0, /* flags */ 0}; /* ENABLED BUS INTR? */
...
/** TODO: Document. */
atm_probe(reg, ui) vm_offset_t reg;
...
static void
    /** TODO: Document. */
    atm_attach(ui) register struct bus_device *ui;
{
}
...
/** TODO: Document. */
atm_intr(unit, spllevel) int unit;
int spllevel;
{
...
/** TODO: Document. */
atm_intr_occurred() { atm_nintrs++; }

/** TODO: Document. */
atm_output(dev, ior) int dev;
io_req_t ior;
{
}

/** TODO: Document. */
atm_start(unit) int unit;
{
}

/** TODO: Document. */
atm_open(dev, flag, ior) int dev;
int flag;
io_req_t ior;
{
...
/** TODO: Document. */
atm_close(dev, flag) int dev;
{
}

/** TODO: Document. */
atm_read(dev, ior) int dev;
io_req_t ior;
{
}

/** TODO: Document. */
atm_write(dev, ior) int dev;
io_req_t ior;
{
}

/** TODO: Document. */
atm_get_status(dev, flavor, status, status_count) int dev;
int flavor;
...
/** TODO: Document. */
atm_set_status(dev, flavor, status, status_count) int dev;
int flavor;
dev_status_t status;
...
/** TODO: Document. */
atm_setinput(dev, receive_port, priority, filter, filter_count) int dev;
...
/** TODO: Document. */
atm_portdeath(dev, port) int dev;
mach_port_t port;
{
}
