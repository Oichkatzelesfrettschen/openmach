...
/** TODO: Document. */
nw_result spans_open(nw_ep ep, nw_address_1 rem_addr_1, nw_address_2 rem_addr_2,
                     nw_ep remote_ep) {
  nw_result rc;
...
/** TODO: Document. */
nw_result spans_add(nw_ep ep, nw_address_1 rem_addr_1, nw_address_2 rem_addr_2,
                    nw_ep remote_ep) {
  nw_result rc;
...
/** TODO: Document. */
nw_result spans_drop(nw_ep ep, nw_address_1 rem_addr_1, nw_address_2 rem_addr_2,
                     nw_ep remote_ep) {
  nw_result rc;
