...
/** TODO: Document. */
extern nw_result mk_endpoint_status(nw_ep ep, nw_state_t state, nw_peer_t peer);
...
/** TODO: Document. */
extern nw_buffer_t mk_rpc(nw_ep ep, nw_buffer_t send_msg, nw_options options,
                          int time_out);
