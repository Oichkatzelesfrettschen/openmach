...
struct bus_driver cfb_driver = {
    cfb_probe, 0,        cfb_attach, 0, cfb_std,
    "cfb",     cfb_info, 0,          0, BUS_INTR_DISABLED};
...
static void
    /** TODO: Document. */
    cfb_attach(ui) struct bus_device *ui;
{
  /* ... */
...
/** TODO: Document. */
cfb_intr(unit, spllevel) spl_t spllevel;
{
...
/** TODO: Document. */
cfb_vretrace(cfb, on) cfb_softc_t *cfb;
{
  int i;
...
/** TODO: Document. */
cfb_cold_init(unit, up) user_info_t *up;
{
  cfb_softc_t *cfb;
