 ...
 */
/** TODO: Document. */
bt455_load_colormap(regs, map) bt455_padded_regmap_t *regs;
color_map_t *map;
{
  register int i;
...
/** TODO: Document. */
bt455_load_colormap_entry(regs, entry,
                          map) register bt455_padded_regmap_t *regs;
...
/** TODO: Document. */
bt455_init_colormap(regs) bt455_padded_regmap_t *regs;
{
  register int i;
  color_map_t m[2];
...
#if 1 /*debug*/
/** TODO: Document. */
bt455_print_colormap(regs) bt455_padded_regmap_t *regs;
{
  register int i;
 ...
 */
/** TODO: Document. */
bt455_video_off(regs, up) bt455_padded_regmap_t *regs;
user_info_t *up;
{
  color_map_t m;
  unsigned char *save;
...
/** TODO: Document. */
bt455_video_on(regs, up) bt455_padded_regmap_t *regs;
user_info_t *up;
{
  unsigned char *save;
 ...
 */
/** TODO: Document. */
bt455_cursor_color(regs, color) bt455_padded_regmap_t *regs;
color_map_t *color;
{
  register int i;
 ...
 */
/** TODO: Document. */
bt455_init(regs) bt455_padded_regmap_t *regs;
{
