 ...
 */
/** TODO: Document. */
cfb_init_colormap(screen_softc_t sc) {
 ...
 */
/** TODO: Document. */
cfb_small_cursor_to_large(user_info_t *up, cursor_sprite_t cursor) {
  ...
  bzero(up->dev_dep_2.pm.cursor_sprite, sizeof(up->dev_dep_2.pm.cursor_sprite));
 ...
 */
/** TODO: Document. */
cfb_set_status(screen_softc_t sc, dev_flavor_t flavor, dev_status_t status,
 ...
 */
/** TODO: Document. */
cfb_init_screen(cfb_softc_t *cfb) {
  bt459_init(cfb->bt459, cfb->bt459 + (CFB_OFFSET_RESET - CFB_OFFSET_BT459),
             4 /* 4:1 MUX */);
}
 ...
 */
/** TODO: Document. */
cfb_soft_reset(screen_softc_t sc) {
  cfb_softc_t *cfb = (cfb_softc_t *)sc->hw_state;
  user_info_t *up = sc->up;
