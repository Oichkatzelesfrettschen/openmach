...
extern int
/** TODO: Document. */
dtop_null_device_handler(dtop_device_t dev, dtop_message_t msg, int event,
                         unsigned char outc),
    /** TODO: Document. */
    dtop_locator_handler(dtop_device_t dev, dtop_message_t msg, int event,
                         unsigned char outc),
    /** TODO: Document. */
    dtop_keyboard_handler(dtop_device_t dev, dtop_message_t msg, int event,
                          unsigned char outc);
