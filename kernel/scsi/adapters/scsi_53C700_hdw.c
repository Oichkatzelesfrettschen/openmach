...
struct bus_driver siop_driver = {
    siop_probe, scsi_slave, scsi_attach, siop_go,    siop_std,
    "rz",       siop_dinfo, "siop",      siop_minfo, BUS_INTR_B4_PROBE};

/*
 * Scripts
 */
struct script siop_script_data_in[] = {},
...
/** TODO: Document. */
siop_state(base) vm_offset_t base;
{
  siop_padded_regmap_t *regs;
  ....return 0;
}
/** TODO: Document. */
siop_target_state(tgt) target_info_t *tgt;
{
  if (tgt == 0)
...
/** TODO: Document. */
static siop_wait(preg, until) volatile unsigned char *preg;
{
  int timeo = 1000000;
...
/** TODO: Document. */
siop_reset(siop, quickly) siop_softc_t siop;
boolean_t quickly;
{
 ...
 */
/** TODO: Document. */
siop_go(sc, tgt, cmd_count, in_count, cmd_only) scsi_softc_t *sc;
target_info_t *tgt;
boolean_t cmd_only;
{
  siop_softc_t siop;
...
/** TODO: Document. */
siop_attempt_selection(siop) siop_softc_t siop;
{
  target_info_t *tgt;
...
/** TODO: Document. */
siop_target_intr(siop) register siop_softc_t siop;
{
