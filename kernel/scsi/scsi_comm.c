...
/** TODO: Document. */
char *sccomm_name(boolean_t internal) { return internal ? "cz" : "comm"; }

/** TODO: Document. */
void scsi_get_message(register target_info_t *tgt, io_req_t ior) {
  scsi_cmd_read_t *cmd;
...
/** TODO: Document. */
void scsi_send_message(register target_info_t *tgt, io_req_t ior) {
