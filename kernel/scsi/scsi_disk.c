 ...
 */
/** TODO: Document. */
void scdisk_read(tgt, secno, ior) register target_info_t *tgt;
...
/** TODO: Document. */
void scdisk_write(tgt, secno, ior) register target_info_t *tgt;
register unsigned int secno;
io_req_t ior;
{
...
/** TODO: Document. */
void scsi_reassign_blocks(tgt, defect_list, n_defects,
                          ior) register target_info_t *tgt;
...
/** TODO: Document. */
void scsi_medium_removal(tgt, allow, ior) register target_info_t *tgt;
boolean_t allow;
io_req_t ior;
{
...
io_req_t ior;
{
  ...
  cmd->scsi_cmd_lun_and_lba1 =
      mode &
      (SCSI_CMD_FMT_FMTDATA | SCSI_CMD_FMT_CMPLIST | SCSI_CMD_FMT_LIST_TYPE);
...
/** TODO: Document. */
void scsi_long_read(tgt, secno, ior) register target_info_t *tgt;
register unsigned int secno;
io_req_t ior;
{
...
/** TODO: Document. */
void scsi_long_write(tgt, secno, ior) register target_info_t *tgt;
register unsigned int secno;
io_req_t ior;
{
...
#ifdef SCSI2
scsi_lock_cache scsi_prefetch scsi_read_defect_data
    scsi_sync_cache scsi_write_same
#endif SCSI2
#endif /* NSCSI > 0 */
