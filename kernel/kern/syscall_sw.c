...
#include <mach/message.h>
        ...
        /*
         *	To add a new entry:
         *		Add an "MACH_TRAP(routine, arg count)" to the table
         *below.
         *
...
/** Table of Mach system call trap handlers. */
...
#if MACH_IPC_COMPAT
    MACH_TRAP(task_self, 0),
    /* 10 */ /* obsolete */
    MACH_TRAP(thread_reply, 0),
    /* 11 */ /* obsolete */
    MACH_TRAP(task_notify, 0),
    /* 12 */ /* obsolete */
    MACH_TRAP(thread_self, 0),
    /* 13 */                            /* obsolete */
...
#if MACH_IPC_COMPAT
    MACH_TRAP(msg_send_trap, 4),
    /* 20 */ /* obsolete */
    MACH_TRAP_STACK(msg_receive_trap, 5),
    /* 21 */ /* obsolete */
    MACH_TRAP_STACK(msg_rpc_trap, 6),
    /* 22 */                           /* obsolete */
#else                                  /* MACH_IPC_COMPAT */
...
/** Number of entries in mach_trap_table. */
